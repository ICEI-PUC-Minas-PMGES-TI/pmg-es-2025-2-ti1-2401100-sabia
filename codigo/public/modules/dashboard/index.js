/**
 * Dashboard SABIAA - Versão Dinâmica
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (!sabiaAuth || !sabiaAuth.verificarLogin()) {
...
function inicializarHeader() {
    ...
    if (userName && usuarioLogado) {
        userName.textContent = usuarioLogado.nome || usuarioLogado.email.split('@')[0];
    }
    
    if (userAvatar && usuarioLogado?.fotoPerfil) {
        userAvatar.src = usuarioLogado.fotoPerfil;
    }
}

/**
 * Inicializa comportamento da sidebar
 */
